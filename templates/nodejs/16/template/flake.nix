{
  ...
  inputs.nixpkgs_23_05.url = "github:NixOS/nixpkgs/release-23.05";
  inputs.flake-utils.url = "github:numtide/flake-utils";

  outputs = { self, nixpkgs, nixpkgs_23_05, flake-utils }:
    let
    ...
    flake-utils.lib.eachSystem systems (system:
      let
        ...
        pkgs_23_05 = import nixpkgs_23_05 {
          inherit system;
          # Node 16 became EOL during the 23.05 cycle, so it was marked insecure, which prevents installation by default
